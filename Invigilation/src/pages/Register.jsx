            ...
            <div className="auth-card">
                ...
                <div className="auth-visual">
                    <div className="relative w-full max-w-[320px]">
                        {/* Simple SVG Illustration representing the image's vibe */}
                        <svg viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect x="230" y="40" width="60" height="80" rx="15" fill="#FF6B4E" opacity="0.4" />
                            <path d="M260 40 L 260 20 Q 260 0 280 0 Q 300 0 300 20 L 300 40" stroke="#FF6B4E" strokeWidth="6" strokeLinecap="round" fill="none" />
                        </svg>
                    </div>
                </div>
                ...
                <div className="auth-form-side">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="flex items-center gap-3 mb-8">
                            <input type="checkbox" className="auth-checkbox" id="terms" />
                            <label htmlFor="terms" className="text-xs font-bold text-text-muted">
                                I agree to <span className="text-primary">Platforms Terms of Service</span> and <span className="text-primary">Privacy Policy</span>
                            </label>
                        </div>
